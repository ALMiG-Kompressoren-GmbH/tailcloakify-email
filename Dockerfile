...
ARG VITE_BACKGROUND_EMAIL_IMAGE_URL="https://mailwind.blob.core.windows.net/website/blurred-background-transparency.jpg"
ARG VITE_EMAIL_LOGO=""
ARG VITE_EMAIL_LOGO_ALT=""

ENV VITE_BACKGROUND_EMAIL_IMAGE_URL=${VITE_BACKGROUND_EMAIL_IMAGE_URL}
ENV VITE_EMAIL_LOGO=${VITE_EMAIL_LOGO}
ENV VITE_EMAIL_LOGO_ALT=${VITE_EMAIL_LOGO_ALT}
