...
ARG TAILCLOAKIFY_EMAIL_BACKGROUND_IMAGE_URL=""
ARG TAILCLOAKIFY_EMAIL_LOGO=""
ARG TAILCLOAKIFY_EMAIL_FONT_FAMILY=""
ARG TAILCLOAKIFY_EMAIL_CONTACT=""

ENV TAILCLOAKIFY_EMAIL_BACKGROUND_IMAGE_URL=${TAILCLOAKIFY_EMAIL_BACKGROUND_IMAGE_URL}
ENV TAILCLOAKIFY_EMAIL_LOGO=${TAILCLOAKIFY_EMAIL_LOGO}
ENV TAILCLOAKIFY_EMAIL_FONT_FAMILY=${TAILCLOAKIFY_EMAIL_FONT_FAMILY}
ENV TAILCLOAKIFY_EMAIL_CONTACT=${TAILCLOAKIFY_EMAIL_CONTACT}
