        ...
        <Text style={paragraph}>
          ...
          <p>
            {t("execute-actions.linkExpiry", {
              linkExpiration: "${linkExpirationFormatter(linkExpiration)}", interpolation: { escapeValue: false }
            })}
          </p>
          <p>
          ...
          <ul>
            <strong>
              <Raw
                  content="<#list (requiredActions![]) as r><li>${msg('requiredAction.' + r)}</li></#list>"/>
            </strong>
          </ul>
          <Raw content="</#if>"/>
